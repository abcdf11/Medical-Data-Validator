...
When running the pipeline against a dirty dataset(`medications_2.csv`), the terminal generates an easy-to-read audit report. Here is an example of the script catching missing codes and invalid payer coverage amounts:
```text
